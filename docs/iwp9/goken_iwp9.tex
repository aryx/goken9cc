...
\begin{abstract}
\goken is a new project attempting to unify in one repository the many
improvements to the original \plan toolchain. The goal is to provide
assemblers, linkers, and C compilers for modern architectures that
can produce binaries not only for \plan but also Linux, macOS, and Windows.
\end{abstract}
...
% code. 
% shift machine code generation from assembler to linker.
