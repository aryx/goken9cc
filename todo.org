...
**** LATER RELAX drop legacy hunk/bump allocator in cck/lexbody
claude:
...
**** TODO bound macexpand() against overflow
claude:
...
**** TODO fix wrong regalloc template in constant compound-assign fast path
claude:
...
**** TODO make struct-copy temp (nodrat) reentrant
claude:
...
**** TODO honor DUPOK on data symbols in datblk()
claude:
